...
export const steps = [
  {
    number: "01",
    title: "Consultation",
    description: "Understanding your needs, style and budget.",
    icon: (
  ...
  },
  {
    number: "02",
    title: "Design",
    description: "Creating thoughtful designs that reflect your vision.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.3" className="size-6">
  ...
  },
  {
    number: "03",
    title: "Planning",
    description: "Detailed planning, material selection and scheduling.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.3" className="size-6">
  ...
  },
  {
    number: "04",
    title: "Execution",
    description: "Civil, electrical, plumbing & carpentry work with precision.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.3" className="size-6">
  ...
  },
  {
    number: "05",
    title: "Finishing",
    description: "Flawless finishes, textures and detailing.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.3" className="size-6">
  ...
  },
  {
    number: "06",
    title: "Handover",
    description: "Final walkthrough and on-time delivery with complete care.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.3" className="size-6">
...
const guarantees = [
  {
    ...
    description: "We take complete ownership of your project.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.3" className="size-6">
  ...
  },
  {
    ...
    description: "Committed to timelines, every single time.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.3" className="size-6">
      ...
      <div className="mx-auto max-w-[1380px] px-5 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="relative mt-20 hidden lg:block">
          ...
          >
            ...
            {/* 
              - Top row nodes: X = 200, 600, 1000 | Y = 48
              - Right outer curve wraps from (1000, 48) to (1140, 175) to (1000, 205)
              - Long middle traverse goes right to left from (1000, 205) to (200, 205)
              - Left outer curve wraps around 04 from (200, 205) to (60, 255) to (200, 305)
              - Bottom row straight line: from (200, 305) to (1000, 305)
              - Tail hooks out to terminal dot at (1070, 325)
            */}
            <path
              d="
                M 200 48
                L 1000 48
                C 1140 48, 1140 205, 1000 205
                L 200 205
                C 60 205, 60 305, 200 305
                L 1000 305
                C 1030 305, 1050 325, 1070 325
              "
            ...
            {/* Terminal glowing dot at the end of handover */}
          ...
          {steps.map((step) => (
            <div key={step.number} className="relative flex items-start gap-4 z-10">
              <div className="relative flex size-16 shrink-0 items-center justify-center rounded-full border border-[#D5C6B0] bg-[#FAF8F5] shadow-sm">
                ...
                <div className="text-[#B58544] scale-90">{step.icon}</div>
              </div>
