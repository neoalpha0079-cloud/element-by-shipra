...
export const services = [
  {
    ...
    mobileTitle: "Interior Design",
    description:
      "Beautiful interiors crafted around your lifestyle and personality.",
    image:
      "https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=900&q=80",
    icon: (
      <svg viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="1.2" className="w-8 h-8">
  ...
  {
    number: "02",
    title: "EXTERNAL ELEVATION",
    mobileTitle: "External Elevation",
    description:
      "Striking exteriors that create a lasting impression and add true value.",
    image:
  ...
  },
  {
    ...
    mobileTitle: "Vastu Consultation",
    description:
      "Balanced spaces that promote positivity, harmony and well-being.",
    image:
  ...
  },
  {
    ...
    mobileTitle: "Commercial Designing",
    description:
  ...
  },
  {
    ...
    mobileTitle: "Modular Furniture",
    description:
      "Custom modular solutions that combine style, smart storage and lasting quality.",
    image:
...
export function ServicesSection() {
  // Height and clip offsets for the distinctive peak shape
  const heights = [
    "h-[330px]",
    "h-[395px]",
    "h-[480px]",
  ...
  const clipPaths = [
    "polygon(0 32%, 100% 16%, 100% 100%, 0% 100%)", // 01
    "polygon(0 16%, 100% 0%, 100% 100%, 0% 100%)",   // 02
    "polygon(0 0%, 100% 0%, 100% 100%, 0% 100%)",     // 03 peak
    "polygon(0 0%, 100% 16%, 100% 100%, 0% 100%)",   // 04
    "polygon(0 16%, 100% 32%, 100% 100%, 0% 100%)", // 05
  ];

  return (
    <section className="relative overflow-hidden bg-[#FBF9F5] py-16 md:py-24 selection:bg-[#c59a58]/20 font-sans">
      {/* Delicate background branch ornament */}
      ...
      <div className="mx-auto max-w-[1360px] px-4 sm:px-6 lg:px-12">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-md text-[13px] leading-relaxed text-[#6E675E] sm:text-[14px]">
            End-to-end services that blend aesthetics, functionality and
            timeless elegance.
          </p>
        </div>
        ...
        <div className="mt-20 hidden lg:grid lg:grid-cols-5 relative">
          {/* Continuous Gold Contour Baseline */}
<div 
          className="absolute top-0 inset-x-0 h-0.5 z-20 pointer-events-none clip-service-contour"
        />
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="px-6 pb-6 text-left flex flex-col">
                <span className="font-serif text-[28px] leading-none text-[#B58544]">
                  {service.number}
                </span>
        ...
        <div className="mt-10 lg:hidden space-y-3.5">
          {services.map((service) => (
            <div
              key={service.number}
              className="group relative flex h-[105px] items-stretch justify-between overflow-hidden rounded-[14px] border border-[#E9E2D5] bg-white shadow-[0_4px_20px_rgba(0,0,0,0.02)] transition-transform active:scale-[0.99]"
            >
              {/* Left Column: Number, Title & Chevron */}
              <div className="flex flex-1 flex-col justify-center pl-6 pr-2 z-10">
                <span className="font-serif text-[17px] leading-none text-[#B58544]">
                  {service.number}
                </span>
                <div className="mt-2 flex items-center justify-between">
                  <h3 className="font-serif text-[16px] font-normal text-[#1E1B18]">
                    {service.mobileTitle}
                  </h3>
              ...
              {/* Right Column: Angled Cut Image */}
              <div
                className="relative w-[38%] min-w-[135px] h-full clip-service-mobile"
              >
                <Image
                  src={service.image}
                  alt={service.title}
          ...
          <div className="relative mt-4 flex items-center justify-between overflow-hidden rounded-[14px] bg-[#EFE8DC]/80 px-6 py-5 border border-[#E4D9C8]">
            ...
            <div className="relative z-10">
              ...
              <h4 className="mt-0.5 font-serif text-[19px] text-[#B58544]">
