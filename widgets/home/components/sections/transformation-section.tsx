...
// Fallback images if data file isn't populated
  ...
  return (
    <section className="relative overflow-hidden bg-[#141210] py-4 sm:py-6 font-sans">
      <div className="mx-auto max-w-[1440px] px-3 sm:px-6 lg:px-8">
        {/* ================= SECTION MAIN CARD ================= */}
        <div 
          className="relative bg-[#ECE5DB] px-6 py-8 sm:px-10 sm:py-10 lg:px-14 lg:py-12 clip-pointer-events"
        >
          {/* Header Row */}
          <div className="flex items-start justify-between gap-4 mb-6 md:mb-8">
            <div>
              {/* Eyebrow with Trailing Golden Dash */}
          ...
          <div className="relative w-full">
            ...
            >
              {/* AFTER IMAGE (Underneath Full Background) */}
              ...
              {/* BEFORE IMAGE (Clipped Layer with Grayscale Aesthetic) */}
              <div
