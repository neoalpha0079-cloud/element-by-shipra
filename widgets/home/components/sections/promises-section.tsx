...
export const promises = [
  {
    number: "01",
    title: "Turnkey\nApproach",
    mobileTitle: "Turnkey Approach",
    description: "Complete design-to-execution under one roof.",
    arcColor: "#B58544",
    iconColor: "text-[#B58544]",
    icon: (
      <svg viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="1.3" className="size-7">
  ...
  },
  {
    number: "02",
    title: "99.99% Design\nAchievement",
    mobileTitle: "99.99% Design Achievement",
    description: "Bringing the approved design vision to reality with precision.",
    arcColor: "#1A1816",
    iconColor: "text-[#1A1816]",
    icon: (
      <svg viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="1.3" className="size-7">
  ...
  },
  {
    number: "03",
    title: "Within\nEstimated Budget",
    mobileTitle: "Within Estimated Budget",
    description: "Smart planning and execution aligned with the estimated budget.",
    arcColor: "#B58544",
    iconColor: "text-[#B58544]",
    icon: (
      <svg viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="1.3" className="size-7">
  ...
  },
  {
    number: "04",
    title: "10+ Years of\nExperience",
    mobileTitle: "10+ Years of Experience",
    description: "A decade of expertise in interior design and execution.",
    arcColor: "#1A1816",
    iconColor: "text-[#1A1816]",
    icon: (
      <svg viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="1.3" className="size-7">
  ...
  },
  {
    number: "05",
    title: "Vastu-Based\nDesign",
    mobileTitle: "Vastu-Based Design",
    description: "Thoughtfully designed spaces that promote positivity and harmony.",
    arcColor: "#B58544",
    iconColor: "text-[#B58544]",
    icon: (
      <svg viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="1.3" className="size-7">
...
export function PromisesSection() {
  return (
    <section className="relative overflow-hidden bg-[#FBF9F5] py-16 md:py-24 font-sans selection:bg-[#c59a58]/20">
      {/* Top Left Fluid Organic Photo (Desktop) */}
      ...
      <div className="mx-auto max-w-[1380px] px-5 sm:px-8 lg:px-12">
        ...
        <div className="mt-20 hidden lg:grid lg:grid-cols-5 relative divide-x divide-[#E8DFC8]/70">
          {promises.map((item) => (
            ...
            >
              {/* Number */}
              <span className="font-serif text-[26px] leading-none text-[#B58544]">
                {item.number}
              </span>
              ...
              {/* Title */}
              <h3 className="mt-8 font-sans text-[16px] font-bold leading-snug text-[#1A1816] whitespace-pre-line min-h-[44px]">
                {item.title}
              </h3>
              ...
              {/* Description */}
              <p className="mt-4 text-[12px] leading-relaxed text-[#6E675E] max-w-[190px]">
                {item.description}
              </p>
            </div>
          ))}
        ...
        <div className="mt-10 space-y-3 lg:hidden">
          {promises.map((item) => (
            <div
              key={item.number}
              className="group relative flex items-center justify-between rounded-[18px] border border-[#E9E2D5] bg-white p-4 shadow-[0_4px_20px_rgba(0,0,0,0.02)] transition-transform active:scale-[0.99]"
            >
              {/* Left Arc Icon */}
              ...
              <div className="flex-1 pl-4 pr-2">
                <div className="flex items-center gap-2">
                  <span className="font-serif text-[15px] font-medium text-[#B58544]">
                    {item.number}
                  </span>
                ...
                <p className="mt-1 text-[11px] leading-tight text-[#6E675E]">
                  {item.description}
                </p>
              </div>
        ...
        <div className="mt-6 lg:hidden">
          <button
            type="button"
            className="flex h-12 w-full items-center justify-between rounded-full bg-[#161616] px-6 text-white shadow-md active:scale-95 transition-transform"
          >
